 ...
 */
class DefaultSummonsRepository(
    private val summonsRemoteDataSource: SummonsRemoteDataSource,
    private val summonsLocalDataSource: SummonsLocalDataSource,
    ...
    private suspend fun updateTasksFromRemoteDataSource() {
        ...
        if (remoteTasks is com.example.myapplication.data.Result.Success) {
    ...
    private suspend fun updateTaskFromRemoteDataSource(taskId: String) {
        ...
        if (remoteTask is com.example.myapplication.data.Result.Success) {
    ...
    override suspend fun completeTask(taskId: String) {
        withContext(ioDispatcher) {
            (getTaskWithId(taskId) as? com.example.myapplication.data.Result.Success)?.let { it ->
